...
echo -e "${BLUE}Sandbox Version:${NC} $(aztec-cli --version)"
echo -e "${BLUE}Aztec CLI Path:${NC} $(which aztec-cli)"
...
echo -e "${BLUE}Successfully compiled brillig bug contracts.${NC}"